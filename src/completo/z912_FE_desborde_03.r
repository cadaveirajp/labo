...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , jpcv_ctrx_q_nor         := ctrx_quarter_normalizado  / mtarjeta_visa_consumo ]
  dataset[ , jpcp_ctrx_q_nor         := ctrx_quarter_normalizado  / cpayroll_trx ]
  dataset[ , jpcv_mcuentas_saldo     := mcuentas_saldo  / mtarjeta_visa_consumo ]
  dataset[ , jpcp_mcuentas_saldo     := mcuentas_saldo  / cpayroll_trx ]
  dataset[ , jpcp_mcaja_ahorro       := mcaja_ahorro  / cpayroll_trx ]
  dataset[ , jpcp_mdescubierto_preacordado     := mdescubierto_preacordado  / cpayroll_trx ]
  dataset[ , jpcd_mcaja_ahorro       := mcaja_ahorro  / mdescubierto_preacordado ]
  dataset[ , jpcd_mcpayroll_trx       := cpayroll_trx  / mdescubierto_preacordado ]
  dataset[ , jpcpp_mcaja_ahorro       := mcaja_ahorro  / mprestamos_personales ]
