...
dir.create( "./KA5710/", showWarnings = FALSE )
setwd("/Users/jpc/Documents/00 Data Science Big data Carreer AI/01 Universidad Austral 2022/01_LabImp01/labo/exp/KA5710/") 

archivo_salida  <- "./KA_571_001.csv"
