...
param  <- list( "num.trees"=       2062,  #cantidad de arboles
                "mtry"=             8,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  423,  #tamaño minimo de las hojas
                "max.depth"=        11   # 0 significa profundidad infinita
              )

set.seed(101963) #Establezco la semilla aleatoria
...
dir.create( "./KA2411/", showWarnings = FALSE )
setwd("/Users/jpc/Documents/00 Data Science Big data Carreer AI/01 Universidad Austral 2022/01_LabImp01/labo/exp/KA2411/") 

archivo_salida  <- "./KA_411_001.csv"
